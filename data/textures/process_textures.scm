...
;;
;;   "Hotel Nuclear" is free software; you can redistribute it and/or modify
...
;;   along with "Hotel Nuclear"; if not, write to the Free Software
...
;;;; hotel-nuclear generation -----------------------------------------------------

(define (kam-normal-maps input-filename)
  (let* ((output-filename
...
(define (kam-batch-normal-maps)

  (let* ((filelist (cadr (file-glob "*.png" 1))))
    (while (not (null? filelist))
       (let* ((filename (car filelist)))
         (kam-normal-maps filename)
